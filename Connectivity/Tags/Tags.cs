...
public static class Info
{
     ...
     */
    public static List<Type> TagTypesList { get; set; } = new()
    {
        typeof(BOOL),
...
{
    public BOOL(int adr, PLC plc) : base(adr, plc) { }
...
{
    public BYTE(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 1;
...
public sealed class WORD : Tag<ushort>
{
    ...
    public WORD(int adr, PLC plc) : base(adr, plc)
    {
...
{
    public DWORD(int adr, PLC plc) : base(adr, plc) { }
    ...
    {
        if (bit is < 0 or > 31) throw new ArgumentOutOfRangeException(nameof(bit));
...
{
    public LWORD(int adr, PLC plc) : base(adr, plc) { }
...
{
    public SINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 1;
...
{
    public USINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 1;
    //protected override void PlcReadComleted() => Value = plc.GetINT(Adr);
}
...
{
    public INT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 2;
    //protected override void PlcReadComleted() => Value = plc.GetINT(Adr);
}
...
{
    public UINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 2;
    //protected override void PlcReadComleted() => Value = plc.GetWORD(Adr);
}
...
{
    public DINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 4;
    //protected override void PlcReadComleted() => Value = plc.GetWORD(Adr);
}
...
{
    public UDINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 4;
    //protected override void PlcReadComleted() => Value = plc.GetWORD(Adr);
}
...
{
    public LINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 8;
    //protected override void PlcReadComleted() => Value = plc.GetULINT(Adr);
}
...
{
    public ULINT(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 8;
    //protected override void PlcReadComleted() => Value = plc.GetULINT(Adr);
}
...
{
    public REAL(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 4;
...
{
    public LREAL(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 8;
    //protected override void PlcReadComleted() => Value = plc.GetREAL(Adr);
}
...
{
    public DATETIME(int adr, PLC plc) : base(adr, plc) { }
    public override int Size => 4;
...
public sealed class STRING : Tag, IGetNextAdr
{
    ...
    public STRING(int adr, PLC plc, int len)
    {
        Adr = adr;
        Size = len;
        Plc = plc;
