    ...
    public class OpcServerManager
    {
        ...
        private bool CreateGroup()
        {
            try
            {
                ...
                i[3].ItemID = OpcConsts.SetMaxPress;
                i[4].ItemID = OpcConsts.SpeedPress;
                //i[5].ItemID = OpcConsts.Instrument;
                //i[6].ItemID = OpcConsts.BlinL;
                //i[7].ItemID = OpcConsts.BlinR;
                i[5].ItemID = OpcConsts.DispPress1;
                i[6].ItemID = OpcConsts.DispPress2;
                i[7].ItemID = OpcConsts.DispPress3;
                i[8].ItemID = OpcConsts.ShowGraph;
                i[9].ItemID = OpcConsts.AlarmBP1;
                i[10].ItemID = OpcConsts.AlarmBP2;
                i[11].ItemID = OpcConsts.AlarmBP3;
